...
nohup bash scripts/train_tk_instruct.sh 2 4,9 t5-base 16 1e-4 0 kd 5 0.05 32 allenai ce_kl fullprompt ffn nowhitening > logs/t5-base-1e-4_kd_warm0.05_r32_allenai_fullprompt_nowhitening_ffn_ce_kl.log 2>&1 &
# nohup bash scripts/train_tk_instruct.sh 2 5,6 t5-base 16 3e-4 0 kd 5 0.05 32 allenai ce_kl fullprompt ffn nowhitening > logs/t5-base-3e-4_kd_warm0.05_r32_allenai_fullprompt_nowhitening_ffn_ce.log 2>&1 &
# nohup bash scripts/train_tk_instruct.sh 2 0,3 t5-base 8 1e-4 0 kd 4 0.04 32 allenai ce fullprompt ffn nowhitening > logs/t5-base-1e-4_kd_warm0.05_r32_allenai_fullprompt_nowhitening_ffn_ce.log 2>&1 &