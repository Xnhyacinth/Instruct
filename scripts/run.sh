...
nohup bash scripts/train_tk_instruct.sh 4 2,3,4,5 t5-xl 4 1e-4 0 kd 3 0.03 32 allenai ce_kl fullprompt ffn nowhitening 0 > logs/t5-xl-1e-4_kd_warm0.04_r32_no_fullprompt_nowhitening_ffn_ce_kl_pos0.log 2>&1 &
