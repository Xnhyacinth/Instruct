...
# sleep 20
nohup bash scripts/train_tk_instruct.sh 2 2,3 t5-base 8 1e-4 0 kd 4 0.03 32 allenai ce_kl fullprompt ffn nowhitening 0 0 nocustom 0 ko 32 > logs/t5-base-1e-4_kd_warm0.05_r32_no_fullprompt_nowhitening_ffn_ce_kl_pos0.log 2>&1 &
# sleep 20
