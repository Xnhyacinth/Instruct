...
# nohup bash scripts/train_tk_instruct.sh 2 5,6 t5-base 8 5e-5 0 kd 5 0.05 32 allenai all fullprompt noffn nowhitening > logs/t5-base-5e-5_kd_warm0.05_r32_allenai_fullprompt_nowhitening_all.log 2>&1 &