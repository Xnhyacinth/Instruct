...
nohup bash scripts/train_tk_instruct.sh 2 5,6 t5-base 8 1e-4 0 kd 0.03 32 allenai > logs/t5-base-1e-4_kd_warm0.03_r32_allenai.log 2>&1 &
# nohup bash scripts/train_tk_instruct.sh 2 1,4 t5-base 8 5e-5 0 kd 0.03 32 allenai > logs/t5-base-5e-5_kd_warm0.03_r32_allenai.log 2>&1 &