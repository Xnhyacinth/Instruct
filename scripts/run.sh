...
# nohup bash scripts/train_tk_instruct.sh 2 4,9 t5-base 16 1e-4 0 kd 5 0.05 32 allenai ce_kl fullprompt ffn nowhitening > logs/t5-base-5e-5_kd_warm0.05_r32_allenai_fullprompt_nowhitening_ffn.log 2>&1 &
