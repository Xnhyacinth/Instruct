...
# nohup bash scripts/train_tk_instruct.sh 2 0,1 t5-base 8 1e-4 0 kd 5 0.05 32 allenai ce_kl fullprompt ffn nowhitening 2 2 custom > logs/t5-base-1e-4_kd_warm0.05_r32_fullprompt_nowhitening_ffn_ce_kl_pos2_custom.log 2>&1 &
