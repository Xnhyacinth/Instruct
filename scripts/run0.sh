...
python down.py
sleep 60
nohup bash scripts/train_tk_instruct.sh 2 6 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt CC > logs0/t5-base-1e-4_lora_warm0.05_pos2_CC.log 2>&1 &
sleep 20
nohup bash scripts/train_tk_instruct.sh 2 0 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt FiTB > logs0/t5-base-1e-4_lora_warm0.05_pos2_FiTB.log 2>&1 &
sleep 20
nohup bash scripts/train_tk_instruct.sh 2 8 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt TQE > logs0/t5-base-1e-4_lora_warm0.05_pos2_StC.log 2>&1 &
sleep 20
nohup bash scripts/train_tk_instruct.sh 2 7 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt Explanation > logs0/t5-base-1e-4_lora_warm0.05_pos2_Explanation.log 2>&1 &
sleep 20
nohup bash scripts/train_tk_instruct.sh 2 1 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt GC > logs0/t5-base-1e-4_lora_warm0.05_pos2_GC.log 2>&1 &
sleep 20
nohup bash scripts/train_tk_instruct.sh 2 9 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt SI > logs0/t5-base-1e-4_lora_warm0.05_pos2_SI.log 2>&1 &

sleep 18200
python down.py
sleep 60
nohup bash scripts/train_tk_instruct.sh 2 6 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt NER > logs0/t5-base-1e-4_lora_warm0.05_pos2_NER.log 2>&1 &
sleep 20
nohup bash scripts/train_tk_instruct.sh 2 0 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt WS > logs0/t5-base-1e-4_lora_warm0.05_pos2_WS.log 2>&1 &
sleep 20
nohup bash scripts/train_tk_instruct.sh 2 8 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt SD > logs0/t5-base-1e-4_lora_warm0.05_pos2_SD.log 2>&1 &
sleep 20
nohup bash scripts/train_tk_instruct.sh 2 7 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt SCo > logs0/t5-base-1e-4_lora_warm0.05_pos2_SCo.log 2>&1 &
sleep 20
nohup bash scripts/train_tk_instruct.sh 2 1 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt TS > logs0/t5-base-1e-4_lora_warm0.05_pos2_TS.log 2>&1 &
sleep 20
nohup bash scripts/train_tk_instruct.sh 2 9 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt Paraphrasing > logs0/t5-base-1e-4_lora_warm0.05_pos2_Paraphrasing.log 2>&1 &

sleep 18200
python down.py
sleep 60
nohup bash scripts/train_tk_instruct.sh 2 6 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt CtT > logs0/t5-base-1e-4_lora_warm0.05_pos2_CtT.log 2>&1 &
sleep 20
nohup bash scripts/train_tk_instruct.sh 2 0 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt GED > logs0/t5-base-1e-4_lora_warm0.05_pos2_GED.log 2>&1 &
sleep 20
nohup bash scripts/train_tk_instruct.sh 2 8 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt SP > logs0/t5-base-1e-4_lora_warm0.05_pos2_SP.log 2>&1 &
sleep 20
nohup bash scripts/train_tk_instruct.sh 2 7 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt Mathematics > logs0/t5-base-1e-4_lora_warm0.05_pos2_Mathematics.log 2>&1 &
sleep 20
nohup bash scripts/train_tk_instruct.sh 2 1 t5-xl 2 1e-4 0 lora 10000 0.01 32 allenai ce fullprompt ffn nowhitening 0 0 nocustom nohyper noko 0 nogpt II > logs0/t5-base-1e-4_lora_warm0.05_pos2_II.log 2>&1 &
sleep 20
